...
<body>
	...
	<main>
			...
			<div class="container">
				...
				<p>
					This is a multiple choise quiz to test your Pyhton Knowledge.
				</p>
				<ul>
					<li><strong>Number of Questions:</strong>10 </li>
					<li><strong>Type:</strong> Multiple Choise</li>
					<li><strong>Estimated Time:</strong> 30 min</li>

				</ul>

				<a href="python-question.php" class="start">Start Quiz</a>
